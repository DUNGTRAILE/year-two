...
--
-- Host: localhost:3306
-- Generation Time: Dec 17, 2024 at 01:15 PM
...
INSERT INTO `posts` (`id`, `title`, `created_at`, `updated_at`, `user_id`, `votes`, `deleted_at`) VALUES
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `grend` enum('male','female') COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Constraints for table `featured_images`
--
ALTER TABLE `featured_images`
